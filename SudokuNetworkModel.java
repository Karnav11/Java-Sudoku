...
public class SudokuNetworkModel extends JDialog{
    ...
    **/
    public SudokuNetworkModel  (JFrame mainView)
    {
        ...
        portInput = new JComboBox<String>(new String[] {"","32150","42150","52150", "61001"});
        ...
        connect.setBackground(new Color(0xB8DAFF));
        cancel.setBackground(new Color(0xB8DAFF));
        
        connect.setBorder(new EtchedBorder(5));
        cancel.setBorder(new EtchedBorder(5));
		...
		Insets ins = new Insets(0,18,0,0);
		straints.insets = ins;
        ...
        outerPanel.setBorder(new EtchedBorder(3, new Color(0x37BFBF), new Color(0x37BFBF)));
        
        outerPanel.add(innerPanel);
        networkPanel.add(outerPanel);
        outerPanel.setBackground(new Color(0xD5F9E8));

        innerPanel.setBackground(new Color(0xD5F9E8));
        
        outerPanel.setPreferredSize(new Dimension(360, 200));
